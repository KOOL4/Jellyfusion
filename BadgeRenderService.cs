...
public class BadgeRenderService
{
    ...
    private static void AddHdrBadge(BaseItem item, BadgesConfig cfg, List<BadgeInfo> list)
    {
        ...
        var hdr = video.VideoRangeType?.ToUpperInvariant() switch
        {
            "DOVI"   => cfg.CustomText.GetValueOrDefault("DolbyVision", "DV"),
            "HDR10+" => cfg.CustomText.GetValueOrDefault("HDR10Plus",   "HDR10+"),
            "HDR10"  => cfg.CustomText.GetValueOrDefault("HDR10",       "HDR10"),
            "HLG"    => cfg.CustomText.GetValueOrDefault("HLG",         "HLG"),
            "HDR"    => cfg.CustomText.GetValueOrDefault("HDR",         "HDR"),
            _        => null
        };
